...
The script can be easily updated to fetch data from another URL such as:
    http://0.0.0.0:5050/status (for testing purposes).
"""
...
def fetch_status():
    ...
    # For testing purposes, you can use: http://0.0.0.0:5050/status
